...
if __name__ == "__main__":
    ...
    if INFERENCE_SINGLE_PIC:
        ...
        total_num = 0
        correct_num = 0
        raw_file_dir = f"{cfg.DIPOORLET.resnet18_outputs}/qnn_resnet18_quant_aimet_adaround"
        ...
        if COMPARE_WITH_ONNX:
            for each_dir, jpg_path in progress_bar:
                raw_dir_path = os.path.join(raw_file_dir, each_dir, "_91.raw")
            ...
            for each_dir, jpg_path in progress_bar:
                ...
                raw_dir_path = os.path.join(raw_file_dir, each_dir, "_241.raw")
                predicted_class_id, _ = parse_raw_data(raw_dir_path)
